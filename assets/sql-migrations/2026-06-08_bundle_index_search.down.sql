-- Rollback for 2026-06-08_bundle_index_search.up.sql
-- Restores et_bundle_index to the 2026-06-08_bundle_index body (no cSearch).
BEGIN;
...
BEGIN
  ...
  SELECT
    d."nBundledetailid", d."nBundleid", b."cBundlename" AS "cFolder", b."cBundletag" AS "cFolderTag",
    d."cTab", d."cFilename" AS "cName", d."cExhibitno", d."cPage", d."cRefpage", d."dIntrestDt",
