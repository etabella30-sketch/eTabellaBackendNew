-- Rollback of 2026-06-09_bundle_index_fast_body.up.sql
-- Restores the BODY branch's cumulative "nPageStart" running-sum window, i.e. the
-- exact function body from 2026-06-08_bundle_index_tree.up.sql.
