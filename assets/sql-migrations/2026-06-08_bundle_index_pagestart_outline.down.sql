-- Rollback for 2026-06-08_bundle_index_pagestart_outline.up.sql
-- Restores et_bundle_index to the 2026-06-08_bundle_index_search body
-- (cSearch, no nPageStart, no bOutline).
BEGIN;
