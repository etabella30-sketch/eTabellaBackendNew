-- 2026-09-07 — DOWN: drop the optional issue details and restore the previous SP bodies
-- (captured verbatim from etabella_tech_uuid on 2026-09-07).
DO $g$ BEGIN
...
ALTER TABLE public."RIssueMaster"
  DROP COLUMN IF EXISTS "cPriority",
  DROP COLUMN IF EXISTS "cDispute",
