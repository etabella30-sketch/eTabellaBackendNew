-- Down: restore et_bundledetail + et_bundledetail_search to their pre-folder-count definitions.
-- Captured live via pg_get_functiondef on 2026-06-04 before applying the .up migration.
BEGIN;
