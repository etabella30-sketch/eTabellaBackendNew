-- Rollback for 2026-06-08_bundle_search_section_label.up.sql
--
-- Restores public.et_bundle_search to its prior body (no cFolder / cFoldertype
-- columns) — byte-identical to the 2026-06-02_bundle_name_search.up.sql version.
-- Safe: the frontend treats the two columns as optional, so reverting only makes
-- unloaded-section groups fall back to the generic "Folders" label again.
