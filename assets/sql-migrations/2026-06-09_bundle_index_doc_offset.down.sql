-- Rollback of 2026-06-09_bundle_index_doc_offset.up.sql
-- Removes the doc-OFFSET branch (and nFindDocid), restoring the function from
-- 2026-06-09_bundle_index_ranked_search.up.sql (outline + ranked search + browse).
