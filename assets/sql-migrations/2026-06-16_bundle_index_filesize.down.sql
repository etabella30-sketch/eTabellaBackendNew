-- 2026-06-16 — et_bundle_index: remove d."cFilesize" on the doc rows
-- (BODY + ranked-search) so the Master Index "Kind" column can show file size.
-- Additive / backward-compatible. Depends on 2026-06-16_bundle_index_filetype.
