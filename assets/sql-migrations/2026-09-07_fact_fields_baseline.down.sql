-- 2026-09-07 — DOWN: previous SP bodies (captured from etabella_tech_uuid), drop nReviewid, restore code wording.
-- The data remap of old nFiletype / nStatus codes is NOT reversed and the inserted code rows stay.
DO $g$ BEGIN
...
END;
$function$;
ALTER TABLE public."FactDetail" DROP COLUMN IF EXISTS "nReviewid";

-- code rows back to their previous names / serials (inserted rows are kept: facts may point at them)
UPDATE "Codemaster" SET "cCodename" = 'Heavily for us',      "nSerialno" = 1 WHERE "nCodeid" = 20 AND "nCategoryid" = 5;
...
UPDATE "Codemaster" SET "cCodename" = 'Heavily against us',  "nSerialno" = 4 WHERE "nCodeid" = 21 AND "nCategoryid" = 5;
UPDATE "Codemaster" SET "cCodename" = 'Against us',          "nSerialno" = 5 WHERE "nCodeid" = 18 AND "nCategoryid" = 5;
UPDATE "Codemaster" SET "nSerialno" = 6 WHERE "nCodeid" = 23 AND "nCategoryid" = 5;
UPDATE "Codemaster" SET "nSerialno" = 5 WHERE "nCodeid" = 17 AND "nCategoryid" = 4;
UPDATE "Codemaster" SET "cCodename" = 'Contract',          "nSerialno" = NULL WHERE "nCodeid" = 50 AND "nCategoryid" = 23;
UPDATE "Codemaster" SET "cCodename" = 'Correspondence',    "nSerialno" = NULL WHERE "nCodeid" = 51 AND "nCategoryid" = 23;
UPDATE "Codemaster" SET "cCodename" = 'Witness Statement', "nSerialno" = NULL WHERE "nCodeid" = 49 AND "nCategoryid" = 23;
UPDATE "Codemaster" SET "cCodename" = 'Expert Report',     "nSerialno" = NULL WHERE "nCodeid" = 48 AND "nCategoryid" = 23;
UPDATE "Codemaster" SET "nSerialno" = 1 WHERE "nCodeid" = 44 AND "nCategoryid" = 24;
UPDATE "Codemaster" SET "nSerialno" = 2 WHERE "nCodeid" = 45 AND "nCategoryid" = 24;
UPDATE "Codemaster" SET "nSerialno" = 3 WHERE "nCodeid" = 46 AND "nCategoryid" = 24;
UPDATE "Codemaster" SET "nSerialno" = 4 WHERE "nCodeid" = 47 AND "nCategoryid" = 24;
