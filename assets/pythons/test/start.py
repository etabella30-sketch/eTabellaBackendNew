...
from file import parse_text,read_file,save_json_file,convert_to_codefeed_data
...
annotations = execute_query('et_realtime_get_annotation_by_session', '{"nSessionid":58}')
...
save_json_file('data/codefeed_data.json', codefeed_data_list)
