...
var _c02 = (a0, a1) => ({ "bg-sgreen": a0, "bg-sred": a1 });
function ToastComponent__svg_path_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 7);
  }
}
function ToastComponent__svg_path_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 8);
  }
}
function ToastComponent_icon_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "icon", 9);
    \u0275\u0275listener("click", function ToastComponent_icon_5_Template_icon_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
function ToastComponent_btn_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "btn", 10);
    \u0275\u0275listener("click", function ToastComponent_btn_6_Template_btn_click_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.action());
    });
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.data == null ? null : ctx_r1.data.button, " ");
  }
}
var ToastComponent = class _ToastComponent {
  ...
  static {
    this.\u0275fac = function ToastComponent_Factory(t) {
      return new (t || _ToastComponent)(\u0275\u0275directiveInject(MAT_SNACK_BAR_DATA));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ToastComponent, selectors: [["app-toast"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 7, vars: 9, consts: [[1, "p-5", "flex", "items-center", "gap-3", 3, "ngClass"], ["xmlns", "http://www.w3.org/2000/svg", "width", "16", "height", "17", "fill", "none", "viewBox", "0 0 16 17"], ["fill", "#fff", "d", "M8 .5a8 8 0 1 0 0 16 8 8 0 0 0 0-16Zm3.44 6.088-3.656 4.8a.799.799 0 0 1-.983.233.8.8 0 0 1-.281-.225L4.568 8.908a.801.801 0 0 1 1.264-.984l1.304 1.664 3.024-4a.805.805 0 0 1 1.28.976v.024Z", 4, "ngIf"], ["fill", "#fff", "d", "M6.695 1.27.185 13.109a1.489 1.489 0 0 0 1.304 2.207H14.51a1.489 1.489 0 0 0 1.305-2.207L9.304 1.271a1.489 1.489 0 0 0-2.609 0ZM8 5.14a.745.745 0 0 1 .745.745v3.97a.745.745 0 1 1-1.489 0v-3.97A.744.744 0 0 1 8 5.14Zm.745 6.949a.744.744 0 1 1-1.489 0 .744.744 0 0 1 1.489 0Z", 4, "ngIf"], [3, "innerHTML"], ["name", "close", "class", "ms-auto cursor-pointer", 3, "click", 4, "ngIf"], ["mode", "white", "class", "ms-5", "addcls", "hover:bg-white", 3, "click", 4, "ngIf"], ["fill", "#fff", "d", "M8 .5a8 8 0 1 0 0 16 8 8 0 0 0 0-16Zm3.44 6.088-3.656 4.8a.799.799 0 0 1-.983.233.8.8 0 0 1-.281-.225L4.568 8.908a.801.801 0 0 1 1.264-.984l1.304 1.664 3.024-4a.805.805 0 0 1 1.28.976v.024Z"], ["fill", "#fff", "d", "M6.695 1.27.185 13.109a1.489 1.489 0 0 0 1.304 2.207H14.51a1.489 1.489 0 0 0 1.305-2.207L9.304 1.271a1.489 1.489 0 0 0-2.609 0ZM8 5.14a.745.745 0 0 1 .745.745v3.97a.745.745 0 1 1-1.489 0v-3.97A.744.744 0 0 1 8 5.14Zm.745 6.949a.744.744 0 1 1-1.489 0 .744.744 0 0 1 1.489 0Z"], ["name", "close", 1, "ms-auto", "cursor-pointer", 3, "click"], ["mode", "white", "addcls", "hover:bg-white", 1, "ms-5", 3, "click"]], template: function ToastComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(1, "svg", 1);
        \u0275\u0275template(2, ToastComponent__svg_path_2_Template, 1, 0, "path", 2)(3, ToastComponent__svg_path_3_Template, 1, 0, "path", 3);
        \u0275\u0275elementEnd();
        \u0275\u0275namespaceHTML();
        \u0275\u0275element(4, "span", 4);
        \u0275\u0275template(5, ToastComponent_icon_5_Template, 1, 0, "icon", 5)(6, ToastComponent_btn_6_Template, 2, 1, "btn", 6);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(6, _c02, !(ctx.data == null ? null : ctx.data.type), (ctx.data == null ? null : ctx.data.type) == "E"));
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", !(ctx.data == null ? null : ctx.data.type));
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", (ctx.data == null ? null : ctx.data.type) == "E");
        \u0275\u0275advance();
        \u0275\u0275property("innerHTML", ctx.data == null ? null : ctx.data.message, \u0275\u0275sanitizeHtml);
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", !(ctx.data == null ? null : ctx.data.button));
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.data == null ? null : ctx.data.button);
      }
    }, dependencies: [IconComponent, CommonModule, NgClass, NgIf, ButtonComponent] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ToastComponent, { className: "ToastComponent", filePath: "src\\app\\shared\\components\\toast\\toast.component.ts", lineNumber: 14 });
})();

// src/app/core/services/tost/tostbar.service.ts
var TostbarService = class _TostbarService {
  constructor(snackBar) {
    this.snackBar = snackBar;
  }
  openSnackBar(message, type = "", duration = 2e3, button = null, actionCallback) {
    this.snackBar.openFromComponent(ToastComponent, {
      data: { message, type, button, actionCallback },
      duration
    });
  }
  error(message) {
  ...
  static {
    this.\u0275fac = function TostbarService_Factory(t) {
      return new (t || _TostbarService)(\u0275\u0275inject(MatSnackBar));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _TostbarService, factory: _TostbarService.\u0275fac, providedIn: "root" });
  }
};
...
//# sourceMappingURL=chunk-NKPXCEC5.js.map
