...
// src/app/presentation/interfaces/tab.interface.ts
var TAB_LIST = [
  {
    icon: "myfiles",
    name: "My File",
  ...
  {
    icon: "corefile",
    name: "Core Case Files",
    value: "C"
  }
];

// src/app/presentation/components/tab/tab.component.ts
function TabComponent_ng_container_1_ng_container_3_Template(rf, ctx) {
  if (rf & 1) {
...
function TabComponent_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "button", 2);
    \u0275\u0275listener("click", function TabComponent_ng_container_1_Template_button_click_1_listener() {
      const item_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.handleTabChange(item_r2.value));
    });
    \u0275\u0275element(2, "icon", 3);
    \u0275\u0275template(3, TabComponent_ng_container_1_ng_container_3_Template, 3, 1, "ng-container", 4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275classProp("text-blue-on", ctx_r2.selectedTab == item_r2.value);
    \u0275\u0275advance();
    \u0275\u0275property("name", item_r2.icon)("type", item_r2.value == "M" ? "extra" : "present");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.selectedTab == item_r2.value);
  }
}
var TabComponent = class _TabComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TabComponent, selectors: [["app-tab"]], inputs: { selectedTab: "selectedTab" }, outputs: { selectedTabChange: "selectedTabChange" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 2, vars: 1, consts: [[1, "flex", "cursor-pointer", "gap-10", "bg-white", "h-[52px]", "px-[30px]", "shadow-[10px_2px_10px_#94949445]"], [4, "ngFor", "ngForOf"], ["type", "button", 1, "flex", "items-center", "h-full", "gap-2.5", "relative", "text-lg", "font-semibold", "bg-transparent", "border-0", "p-0", 3, "click"], [1, "text-lg", 3, "name", "type"], [4, "ngIf"], [1, "absolute", "bottom-0", "h-2", "w-full", "bg-blue-on"]], template: function TabComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
        \u0275\u0275template(1, TabComponent_ng_container_1_Template, 4, 5, "ng-container", 1);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance();
    ...
    }, dependencies: [CommonModule, NgForOf, NgIf, MatTabsModule, IconComponent] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TabComponent, { className: "TabComponent", filePath: "src\\app\\presentation\\components\\tab\\tab.component.ts", lineNumber: 14 });
})();
export {
  TabComponent
};
//# sourceMappingURL=chunk-I3YKM3ZS.js.map
