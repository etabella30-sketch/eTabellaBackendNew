CREATE OR REPLACE FUNCTION public.et_navigate_get_all_test(parameter json, ref1 refcursor, ref2 refcursor, ref3 refcursor)
...
OPEN ref1 FOR 
    ...
    d."jLinktype" AS "grouplink",
		...
		LEFT JOIN "Codemaster" cm ON cm."nCodeid" = CASE WHEN (fd."jDate"->>'type') ~ '^[0-9]+$'  THEN (fd."jDate"->>'type')::int ELSE (fd."jDate"->>'nValue')::int END
