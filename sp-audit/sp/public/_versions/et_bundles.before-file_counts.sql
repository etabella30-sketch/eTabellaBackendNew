-- Frozen copy of et_bundles.sql immediately before the Phase 2.3
-- "bundle_file_counts" migration (2026-05-20). Restore by running this
-- file as-is against the DB, or use 2026-05-20_bundle_file_counts.down.sql.
