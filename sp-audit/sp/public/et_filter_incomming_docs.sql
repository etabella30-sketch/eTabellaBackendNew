CREATE OR REPLACE FUNCTION public.et_filter_incomming_docs(parameter json, ref refcursor)
 RETURNS refcursor
 LANGUAGE plpgsql
AS $function$
...
-- select * from et_filter_incomming_docs('{"nBundledetailid":555364,"nMasterid":2}','r');fetch all in "r"
