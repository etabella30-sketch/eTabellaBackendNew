CREATE OR REPLACE FUNCTION public.fsym_on_u_for_pblc_bdcntcts_trg_lv_grp()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$                                                                                                                
                                ...
                                begin
                                  ...
                                  if 1=1 and "sym".sym_triggers_disabled() != 2 then                                                                                                 
                                    var_row_data := 
          case when new."nBDCtid" is null then '' else '"' || replace(replace(cast(new."nBDCtid" as varchar),$$\$$,$$\\$$),'"',$$\"$$) || '"' end||','||
          ...
          case when new."ZnBDCtid" is null then '' else '"' || cast(cast(new."ZnBDCtid" as numeric) as varchar) || '"' end||','||
          ...
          case when new."ZnUserid" is null then '' else '"' || cast(cast(new."ZnUserid" as numeric) as varchar) || '"' end; 
                                    var_old_data := 
          case when old."nBDCtid" is null then '' else '"' || replace(replace(cast(old."nBDCtid" as varchar),$$\$$,$$\\$$),'"',$$\"$$) || '"' end||','||
          ...
          case when old."ZnBDCtid" is null then '' else '"' || cast(cast(old."ZnBDCtid" as numeric) as varchar) || '"' end||','||
