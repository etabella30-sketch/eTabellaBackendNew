CREATE OR REPLACE FUNCTION public.et_location_share(parameter json, ref refcursor)
 RETURNS refcursor
 LANGUAGE plpgsql
AS $function$
DECLARE nMasterid uuid;
jUsers jsonb;nBundledetailid uuid;jNotify jsonb;nCaseid uuid; nPMid int;
