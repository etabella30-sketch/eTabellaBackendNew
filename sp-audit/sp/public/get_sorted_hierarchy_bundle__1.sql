CREATE OR REPLACE FUNCTION public.get_sorted_hierarchy_bundle(root_folder_id bigint)
 RETURNS TABLE("nSerial" bigint, "nBundleid" integer, "cBundlename" text, "nParentBundleid" integer, "cBundletag" character varying, level integer)
 LANGUAGE plpgsql
AS $function$
BEGIN
    RETURN QUERY
