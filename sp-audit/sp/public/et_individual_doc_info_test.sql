CREATE OR REPLACE FUNCTION public.et_individual_doc_info_test(parameter json, ref refcursor)
 RETURNS refcursor
 LANGUAGE plpgsql
AS $function$
...
b."cExhibitno", b."cFiletype", "cPage", "cRefpage", at."nRotate", at."bIsconvert", b."cFilesize",b."nSectionid", coalesce(nullif(at."cLVer", ''), at."cFVer") version,"cIsindex"
from "BundleDetail" b 
