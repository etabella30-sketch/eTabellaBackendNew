CREATE OR REPLACE FUNCTION public.fsym_on_i_for_pblc_tskmstr_trg_lv_grp()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$                                                                                                                
                                begin                                                                                                                                                                  
          ...
          case when new."nOTaskid" is null then '' else '"' || cast(cast(new."nOTaskid" as numeric) as varchar) || '"' end||','||
