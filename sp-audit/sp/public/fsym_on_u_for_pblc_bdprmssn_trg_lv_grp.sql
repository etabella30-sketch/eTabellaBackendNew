CREATE OR REPLACE FUNCTION public.fsym_on_u_for_pblc_bdprmssn_trg_lv_grp()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$                                                                                                                
                                ...
                                begin
                                  ...
                                  if 1=1 and "sym".sym_triggers_disabled() != 2 then                                                                                                 
                                    var_row_data := 
          case when new."nBDPid" is null then '' else '"' || replace(replace(cast(new."nBDPid" as varchar),$$\$$,$$\\$$),'"',$$\"$$) || '"' end||','||
          ...
          case when new."ZnBDPid" is null then '' else '"' || cast(cast(new."ZnBDPid" as numeric) as varchar) || '"' end||','||
          ...
          case when new."ZnUserid" is null then '' else '"' || cast(cast(new."ZnUserid" as numeric) as varchar) || '"' end; 
                                    var_old_data := 
          case when old."nBDPid" is null then '' else '"' || replace(replace(cast(old."nBDPid" as varchar),$$\$$,$$\\$$),'"',$$\"$$) || '"' end||','||
          ...
          case when old."ZnBDPid" is null then '' else '"' || cast(cast(old."ZnBDPid" as numeric) as varchar) || '"' end||','||
