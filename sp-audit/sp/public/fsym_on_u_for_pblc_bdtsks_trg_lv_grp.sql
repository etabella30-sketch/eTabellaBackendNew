CREATE OR REPLACE FUNCTION public.fsym_on_u_for_pblc_bdtsks_trg_lv_grp()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$                                                                                                                
                                ...
                                begin
                                  ...
                                  if 1=1 and "sym".sym_triggers_disabled() != 2 then                                                                                                 
                                    var_row_data := 
          case when new."nBDTsid" is null then '' else '"' || replace(replace(cast(new."nBDTsid" as varchar),$$\$$,$$\\$$),'"',$$\"$$) || '"' end||','||
          ...
          case when new."ZnBDTsid" is null then '' else '"' || cast(cast(new."ZnBDTsid" as numeric) as varchar) || '"' end||','||
          ...
          case when new."ZnUserid" is null then '' else '"' || cast(cast(new."ZnUserid" as numeric) as varchar) || '"' end; 
                                    var_old_data := 
          case when old."nBDTsid" is null then '' else '"' || replace(replace(cast(old."nBDTsid" as varchar),$$\$$,$$\\$$),'"',$$\"$$) || '"' end||','||
          ...
          case when old."ZnBDTsid" is null then '' else '"' || cast(cast(old."ZnBDTsid" as numeric) as varchar) || '"' end||','||
