CREATE OR REPLACE FUNCTION realtime.et_realtime_issue_by_id(parameter json, ref refcursor)
 RETURNS refcursor
 LANGUAGE plpgsql
AS $function$
...
where 
im."nIid" = nIid
and ic."nCaseid" = nCaseid and (im."nUserid" = nUserid or (im."nUserid" is null and im."nCaseid" = nCaseid))
group by im."nIid", im."cIName", im."cColor",ic."nICid","cCategory", "nTotalID"
,im."nUserid"
