CREATE OR REPLACE FUNCTION helpcenter.fsym_on_u_for_hlpcntr_fqfdbck_trg_lv_grp()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$                                                                                                                
                                ...
                                begin
                                  ...
                                  if 1=1 and "sym".sym_triggers_disabled() != 2 then                                                                                                 
                                    var_row_data := 
          case when new."nFFid" is null then '' else '"' || replace(replace(cast(new."nFFid" as varchar),$$\$$,$$\\$$),'"',$$\"$$) || '"' end||','||
          ...
          case when new."bIsHelpful" is null then '' when new."bIsHelpful" then '"1"' else '"0"' end||','||
          ...
          case when new."ZnFFid" is null then '' else '"' || cast(cast(new."ZnFFid" as numeric) as varchar) || '"' end||','||
