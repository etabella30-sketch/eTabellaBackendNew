/**
 * Verbatim copy of apps/realtime/src/classes/squential.task.ts (Phase-2 plan:
 * "move SequentialTaskQueue as-is"). One instance per SessionContext lane —
 * per-session ordering without cross-session head-of-line blocking.
 */
