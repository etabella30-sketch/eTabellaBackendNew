...
import { AlphaQueueOptions, RabbitMQConfig, RedisConfig } from '@app/alpha-queue/interfaces/queue.interface';
...
export class QueueConnectionManager implements OnModuleDestroy {
    ...
    constructor(
        @Inject('QUEUE_CONFIG') private readonly config: AlphaQueueOptions,
